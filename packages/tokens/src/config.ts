...
async function build() {
  ...
  const lightSD = new StyleDictionary({
    include: primitives,
    source: [resolve(root, 'src/semantic/light.json'), componentTokens],
    platforms: {
      css: {
        transformGroup: 'css',
        prefix: 'surf',
  ...
  const darkSD = new StyleDictionary({
    include: primitives,
    source: [resolve(root, 'src/semantic/dark.json'), componentTokens],
    platforms: {
      css: {
        transformGroup: 'css',
        prefix: 'surf',
  ...
  const brandSD = new StyleDictionary({
    ...
    source: [resolve(root, 'src/semantic/brand.json'), brandComponentTokens],
    platforms: {
      css: {
        transformGroup: 'css',
        prefix: 'surf',
