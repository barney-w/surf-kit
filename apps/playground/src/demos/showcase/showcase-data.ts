...
export const mockConfidenceHigh: ConfidenceBreakdown = {
  ...
  recency: 0.88,
  reasoning:
    "Multiple authoritative sources confirm this information with high consistency.",
};
...
export const mockConfidenceMedium: ConfidenceBreakdown = {
  ...
  recency: 0.55,
  reasoning:
    "Sources partially address the question but some details may be outdated.",
};
...
export const mockConfidenceLow: ConfidenceBreakdown = {
  ...
  recency: 0.3,
  reasoning:
    "Limited relevant sources found. Answer is partially inferred from context.",
};
...
export const mockVerificationFailed: VerificationResult = {
  status: "failed",
  flags: [
    "Unable to verify rate limit claims",
    "Source document appears outdated",
  ],
  claims_checked: 3,
  claims_verified: 1,
};
...
export const accordionItems = [
  ...
  },
  {
    ...
    content:
      "Install via npm: `npm install @surf-kit/core @surf-kit/theme @surf-kit/tokens`",
  },
  {
    key: "theme",
