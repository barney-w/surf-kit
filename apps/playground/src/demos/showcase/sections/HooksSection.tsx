import { Badge, Button, Separator, Stack, Text, TextInput } from '@surf-kit/core'
import { useClipboard, useKeyboardShortcut, useLocalStorage, useMediaQuery } from '@surf-kit/hooks'
      ...
      <Stack gap={6}>
        ...
        <div>
          ...
          <Stack direction="horizontal" gap={2} align="center">
            <Button intent="secondary" size="sm" onPress={() => copy('Hello from surf-kit!')}>
