...
const items = [
  ...
  { key: 'faq2', title: 'How do I install it?', content: 'Run pnpm add @surf-kit/core in your project.' },
  { key: 'faq3', title: 'Is it accessible?', content: 'Yes, all components follow WAI-ARIA patterns.' },
]
