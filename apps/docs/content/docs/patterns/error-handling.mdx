...
Robust error handling is essential for government-facing AI applications. Users must always understand what went wrong and what they can do next. This guide covers common error scenarios and recovery patterns.
    ...
    return (
      <div>
        <Alert intent="warning" title="I'm not sure about this">
          ...
          found, but I recommend contacting the organisation directly for
          confirmation.
        </Alert>
...
function ContentFilterAlert() {
  return (
    <Alert intent="info" title="I cannot help with that">
      I am designed to help with council services. I am not able to assist with
