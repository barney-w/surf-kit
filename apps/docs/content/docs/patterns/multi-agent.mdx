...
Many applications require multiple specialist agents. A planning agent, a support agent, and a general assistant might all serve different parts of the same platform. This guide covers how to theme and manage multi-agent experiences.
...
- Visual differentiation between agents should not rely solely on colour — use names, avatars, and labels.
