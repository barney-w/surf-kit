...
```tsx
<StreamingMessage
  content="Based on the organisation guidelines, you need to submit form PL-01..."
  isStreaming={false}
  phase="complete"
  agentName="Planning Agent"
  sources={[
    { title: 'Planning Guide', url: 'https://council.gov/planning' },
  ]}
  confidence={0.91}
/>
```
...
```tsx
<StreamingMessage
  content="Based on the organisation gui"
  isStreaming={false}
  phase="writing"
...
```tsx
<StreamingMessage
  content="The council tax band for your property..."
  isStreaming
  phase="writing"
  agentName="Assistant"
/>
